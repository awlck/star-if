...
nothing here is taking away a right the code licence gave you — it's
telling you how the project would like its names used.

## The names

The following are names of components of the STAR IF System, used here to
identify the project and its parts:

| Name | What it is |
|---|---|
| **STAR IF** | The system as a whole. |
...
- Feel free to say your project **uses** Starbase, Starforge, Starhelm or
  the Stardata format, or that your game **was built with** the STAR IF
  System.
...
It is not a trademark registration, and none of these names have been
through a trademark search or filing (see `docs/proposal.md` §14.5). It
does not modify `LICENSE`, `stdlib/LICENSE`, or `docs/LICENSE` in any way,
and nothing here restricts what the code licences already permit. If a
future trademark filing changes any of this, that change will be reflected
here, not read into the silence of the code licences.
